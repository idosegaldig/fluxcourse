  ...
  return (
    <div className="flex flex-col gap-[10px] w-full">
      ...
      <div className="flex items-center justify-between w-full">
        <p className="m-0 font-light uppercase whitespace-nowrap"
          style={{ fontSize: 24, letterSpacing: "-0.04em", lineHeight: 1.1, fontFamily: "var(--font-inter), sans-serif", color: "#1f1f1f" }}>{title}</p>
        <ArrowIcon />
      </div>
    </div>
  );
